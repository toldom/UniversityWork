...
int main(int argc, char *argv[]) {
    ...
    //Determining the colour code for the first colour, based on user input
    ...
    //Determining the colour code for the second colour, based on user input
    ...
    //Determining the colour code for the third colour, based on user input
    ...
    //Determining the colour code for the fourth colour, based on user input
    ...
    //Determining the colour code for the fifth colour, based on user input
    ...
    //No more comments below this point
    ...
    signal(SIGUSR1, signalHandlerFn);
