...
public class GoldSettingsScript : MonoBehaviour {
	...
	private int numberOfEnemiesInput;
	
	private void Awake() {
		
		toggleStatus[0] = PlayerPrefs.GetInt("e0Gold", 1);
		toggleStatus[1] = PlayerPrefs.GetInt("e1Gold", 1);
		toggleStatus[2] = PlayerPrefs.GetInt("e2Gold", 1);
		toggleStatus[3] = PlayerPrefs.GetInt("e3Gold", 1);
		toggleStatus[4] = PlayerPrefs.GetInt("e4Gold", 1);
	...
	public void LoadLevelsScreen() {
		...
		PlayerPrefs.SetInt("GoldEnemies", numberOfEnemiesInput);
		SetStatus();
	}
	...
	private void SetStatus() {
		if (boolStatus[0]) {
			PlayerPrefs.SetInt("e0Gold", 1);
		} else {
			PlayerPrefs.SetInt("e0Gold", 0);
		}
		
		if (boolStatus[1]) {
			PlayerPrefs.SetInt("e1Gold", 1);
		} else {
			PlayerPrefs.SetInt("e1Gold", 0);
		}
		
		if (boolStatus[2]) {
			PlayerPrefs.SetInt("e2Gold", 1);
		} else {
			PlayerPrefs.SetInt("e2Gold", 0);
		}
		
		if (boolStatus[3]) {
			PlayerPrefs.SetInt("e3Gold", 1);
		} else {
			PlayerPrefs.SetInt("e3Gold", 0);
		}
		
		if (boolStatus[4]) {
			PlayerPrefs.SetInt("e4Gold", 1);
		} else {
			PlayerPrefs.SetInt("e4Gold", 0);
		}
	}
}
